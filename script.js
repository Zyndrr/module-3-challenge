...
const getRandomEmployee = function (employeesArray) {
  ...
  const winningEmployee = employeesArray[randomIndex];
  console.log(`Congratulations to ${winningEmployee.firstName} ${winningEmployee.lastName}, our random drawing winner!`);
};
